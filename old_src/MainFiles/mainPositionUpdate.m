...
% The position of all Scenario-managed vehicles is updated. Scenario row
% names are projected back into stable legacy numeric ID slots.
...
if sum(stationManagement.vehicleState(stationManagement.activeIDs)==100)>0
    ...
    [simValues.XvehicleEstimatedLegacy(PosUpdateIndex), ...
        simValues.YvehicleEstimatedLegacy(PosUpdateIndex)] = ...
        addPosError( ...
            positionManagement.XvehicleReal(PosUpdateIndex), ...
            positionManagement.YvehicleReal(PosUpdateIndex), ...
