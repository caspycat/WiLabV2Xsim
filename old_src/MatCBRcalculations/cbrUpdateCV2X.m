...
% values and skip sensing-based DCC updates for controlled algorithms.
if ~isfield(stationManagement,'sensingMatrixCV2X')
    ...
    if simParams.technology == constants.TECH_COEX_STD_INTERF
        coex_cbrLTEonlyValues = ...
            sinrManagement.cbrLTE_coexLTEonly(vehiclesToConsider);
    else
        coex_cbrLTEonlyValues = CBRvalues;
    end
    return
end
